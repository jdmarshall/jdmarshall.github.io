...
(*Author's Note: This is an edit of a post that was published in late August, with the rules
listed in ascending order. That version omitted a pair of rules that depend upon each other. It
became obvious that the copy would read easier if the sections were presented in descending order.*)
...
that will increase your Monthly Recurring Revenue. You make the project better instead of just more
tolerable.

This work often also improves code coverage marginally, and usually reduces the number of glitching
tests, which can help sell the effort involved.
...
Root Cause Analysis is a powerful tool, but you can cut yourself using it incorrectly.

Some people really hate the Five Why's. The ones I've been able to talk to have generally complained
about being railroaded into a RCA that is toothless to prevent future incidents from repeating. 
Something is done, but it only partially closes the exact problem that just happened, and not even
satisfactorily. It also does nothing for the class of problems that the incident uncovered. 

But a skilled Lead or Principal, or even a particularly clever mid-career developer can keep things
on the rails. Maybe you don't get to the meat of the real issue for budgetary or pipeline reasons, 
but you can do something substantive if the Why's don't get steered into the ditch.
...
that was intentional, not just a [Hyrum's Law](https://www.hyrumslaw.com/) situation.
...
Many people come into the 5 Why's meeting hot. Everyone wants to talk about the first two Why's, 
but the return on that investment is pretty low. Similarly the last Why can often be a foregone 
conclusion of the 4th, which means it's too late to steer the remediation strategy back to anything
substantive, and not only that, everyone has sort of spent their energy by this point and the 
meeting is losing momentum.

The 3rd Why is the fulcrum of a successful RCA meeting. If you want to judo throw the process away
from failure into a productive outcome, this is where to concentrate your energy. 

It's a bit of a chess game. It's early enough in the process where the non-technical people don't 
quite pick up that you've influenced the outcome as substantially as you have, but it's late enough
in the process where the other technical leadership can often see or suspect the conclusion you're 
aiming for, and can help goose things in the right direction. There aren't many 4ths that fall out 
as a consequence of the 3rd, and as we have already said, the 5th is usually a consequence of the
4th. So once you've gotten people to agree to your proposed 3rd Why, then the rest of the
conversation should flow more or less to the conclusion without you having to push things in an
obvious manner. You can buy a good outcome more cheaply by focusing on the 3rd Why.

### Bus Numbers

Three people need to understand every part of the code, or you collectively don't understand it. 
Anything with less than two is an active liability. When you have 2 people and an understudy, you
can begin to relax, and only check on the progress occasionally, but until then it should be an
active agenda item. These should also inform how you write Done criteria for Epics, because you
can't walk away from an initiative until multiple people actually understand it.
...
when certain preconditions are met, so they can be taken as assumed. And occasionally by rejecting
features as being too expensive to maintain.

### The Rule of Three

Whenever we find three variations on a theme, it's time to rethink the solution to drag the number
of options back to one or two. We often have to do this by resegmenting code. We turn two methods
into three, or three methods into two. This is IME some of the most challenging refactoring work,
especially with trunk-based development or pressure to keep PRs small and plentiful for large
initiatives.

### Rules Get One Exception

One thing I learned early about human cognition, is that we have very, very good recall of rules
that have exactly one exception. Any more than that and people forget. So much so that sometimes it
seems almost wilful - that they know they have plausible deniability by 'forgetting' the rule. Rules
with one exception are not only easier they also help keep us honest.

And then one day I realized that the Rule of Three is a direct consequence of this rule. A set of 
three is a direct violation of the single exception rule. So it doesn't scale unless fixed.

### You Haven't Proven You Can Do Something Until You've Done it Twice

Serendipity or dumb luck can let you finish a task once and convince yourself you know what you're
doing. When you do it a second time, that luck tends to break down and you find out that what you
thought was working, didn't.
...
Good artists borrow, great artists steal. I stole this one from a boss early in my career. The same
boss as the 'doing something twice' rule.
...
As a rough rule of thumb, people will begin attributing functions or entire files as 'yours', once 
git blame shows your name next to the plurality of lines. Anything over 60% for sure, but if 
everyone owns 10 lines and you own 50, they may still attribute the whole 'thing' to you. And that 
can, in some cases, include reformating or refactoring code. Like a lost hatchling, once you get 
your smell on it, it might be yours. Whether you want it or not.

The team cannot grow while you're carrying them your shoulders, or standing on their toes. They need
to fly off to do their own things. You may not actually be saying 'no touchy!' out loud but any file
where all the most recent edits are yours will communicate that all on its own. The same way if you
put dishes next to your neurotic friend's sink and they feel the urge to immediately rearrange them,
you know that they think you 'did it wrong' and they're always going to correct you. Ain't nobody 
got time for that.
