...
This is more or less a good length for a post, so I will end here and next time we can go over 
tuning and error recovery. After that, we can move on to more challenging scenarios, such as 
