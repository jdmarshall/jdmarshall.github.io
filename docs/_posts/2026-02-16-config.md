...
Ayear ago, I signed on as a maintainer for the `node-config` project. This is a tool meant to
...
And that turned out to be about 90% of the remaining work needed. That is always the situation with
