...
[bench-node](https://github.com/RafaelGSS/bench-node), which was still under active development but already supported async tests, and
was created by someone established in the Node.js ecosystem. It already had much better charts for
my purposes, and looked like it could be bent to fit the model I was using. 
